...
var options struct {
	...
	diffFileDir string
	// name of file storing diff keys to be consumed by mutation differ
	inputDiffKeysFileName string
	// name of file storing diff keys to be generated by mutation differ
...
func argParse() {
	...
	flag.StringVar(&options.diffFileDir, "diffFileDir", base.DiffFileDir,
		" directory for storing diffs")
	flag.StringVar(&options.inputDiffKeysFileName, "inputDiffKeysFileName", base.DiffKeysFileName,
		" name of file for storing keys to be diffed by mutation differ")
	flag.StringVar(&options.outputDiffKeysFileName, "outputDiffKeysFileName", base.MutationDiffKeysFileName,
		" name of file for storing diff keys generated by mutation differ")
...
func diffDataFiles() error {
	...
	differDriver := differ.NewDifferDriver(options.sourceFileDir, options.targetFileDir, options.diffFileDir, base.DiffKeysFileName, int(options.numberOfWorkersForFileDiffer), int(options.numberOfBins), int(options.numberOfFileDesc))
...
func runMutationDiffer() {
	...
	differ := differ.NewMutationDiffer(options.sourceUrl, options.sourceBucketName, options.sourceUsername,
		...
		options.targetPassword, options.diffFileDir, options.inputDiffKeysFileName, options.outputDiffKeysFileName,
