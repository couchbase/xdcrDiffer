...
func NewMutationDiffer(sourceClusterUUID, sourceBucketName, sourceBucketUUID string, sourceRef *metadata.RemoteClusterReference,
	...
	retries int, retriesWaitSecs int, duplMapping DuplicatedHintMap, encryptionSvc encryption.EncryptionSvc) *MutationDiffer {
	...
	return &MutationDiffer{
		...
		srcDiffKeysFileName:    utils.DiffKeysFileName(true, fileDifferDir, base.DiffKeysFileName, encryptionSvc),
		tgtDiffKeysFileName:    utils.DiffKeysFileName(false, fileDifferDir, base.DiffKeysFileName, encryptionSvc),
