...
func (oneEntry *oneEntry) String() string {
	return fmt.Sprintf("Key: %v Seqno: %v RevId: %v Cas: %v Expiry: %v Hash: %s",
		oneEntry.Key, oneEntry.Seqno, oneEntry.RevId, oneEntry.Cas, oneEntry.Expiry, hex.EncodeToString(oneEntry.BodyHash[:]))
}
